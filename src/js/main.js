...
var author$project$Main$init = function () {
	...
	var navCmd = _n0.b;
	return _Utils_Tuple2(
		{colors: colors, controlPanel: controlPanel, historyPanel: historyPanel, navState: navState, tabState: rundis$elm_bootstrap$Bootstrap$Tab$initialState},
		navCmd);
}();
...
var rundis$elm_bootstrap$Bootstrap$Navbar$collapseLarge = rundis$elm_bootstrap$Bootstrap$Navbar$toggleAt(rundis$elm_bootstrap$Bootstrap$General$Internal$LG);
...
var author$project$Main$control = function (model) {
	return A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Events$onClick(author$project$Main$Control),
											elm$html$Html$Attributes$id('controlBut')
										]))
								]),
							_List_fromArray(
								[
									elm$html$Html$text(model.controlPanel.button)
								]))
						]))
				]),
			A2(
...
var author$project$Main$history = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$style, 'height', '22px'),
						A2(elm$html$Html$Attributes$style, 'width', '100%'),
						A2(elm$html$Html$Attributes$style, 'text-align', 'center'),
						elm$html$Html$Attributes$class('control'),
						elm$html$Html$Attributes$id('hisBut'),
						elm$html$Html$Events$onClick(author$project$Main$History)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$src(model.historyPanel.button),
								A2(elm$html$Html$Attributes$style, 'width', '20px'),
								A2(elm$html$Html$Attributes$style, 'height', '20px'),
								A2(elm$html$Html$Attributes$style, 'padding-bottom', '1px')
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						A2(elm$html$Html$Attributes$style, 'height', '178px'),
						A2(elm$html$Html$Attributes$style, 'width', '100%'),
						A2(elm$html$Html$Attributes$style, 'background', model.colors.history),
...
var author$project$Main$multiTab = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2(elm$html$Html$Attributes$style, 'transition', 'all 0.3s'),
				A2(elm$html$Html$Attributes$style, 'padding', '10px'),
				elm$html$Html$Attributes$id('content-his')
			]),
		_List_Nil);
};
var author$project$Main$mainContent = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$multiTab(model),
				author$project$Main$history(model)
			]));
};
...
var author$project$Main$select = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$for('myselect')
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Node Color')
									])),
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Number of People')
											])),
										A2(
										rundis$elm_bootstrap$Bootstrap$Form$Select$item,
										_List_Nil,
										_List_fromArray(
											[
												elm$html$Html$text('Volume of Interaction')
											])),
										A2(
										rundis$elm_bootstrap$Bootstrap$Form$Select$item,
										_List_Nil,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$for('myselect2')
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Node Size')
									])),
								A2(
								rundis$elm_bootstrap$Bootstrap$Form$Select$select,
								_List_fromArray(
...
var author$project$Main$tab = function (model) {
	return A2(
				...
				[
					rundis$elm_bootstrap$Bootstrap$Tab$item(
					{
						...
						pane: A2(
							...
							_List_fromArray(
								[
									A2(elm$html$Html$Attributes$style, 'height', 'calc(100vh - 46px)')
								]),
							_List_fromArray(
								[
									author$project$Main$select(model),
									A2(
									elm$html$Html$div,
									_List_fromArray(
										[
					...
					rundis$elm_bootstrap$Bootstrap$Tab$item(
					{
						...
						pane: A2(
							...
							_List_fromArray(
								[
									elm$html$Html$text('Tab 1 Content')
								]))
					}),
					rundis$elm_bootstrap$Bootstrap$Tab$item(
					{
						...
						pane: A2(
							...
							_List_fromArray(
								[
									elm$html$Html$text('Tab 2 Content')
								]))
					})
				]),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Main$control(model),
						...
						_List_fromArray(
							[
								...
								A2(elm$html$Html$Attributes$style, 'height', '100%'),
								A2(elm$html$Html$Attributes$style, 'background', model.colors.control),
								A2(elm$html$Html$Attributes$style, 'transition', 'all 0.3s'),
								A2(elm$html$Html$Attributes$style, 'margin-right', model.controlPanel.margin),
								A2(elm$html$Html$Attributes$style, 'color', 'white')
							]),
						_List_fromArray(
							[
								author$project$Main$tab(model)
							]))
					]))
			]));
};
